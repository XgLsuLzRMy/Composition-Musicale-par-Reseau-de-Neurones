...
nomFichier = subprocess.call("mididump.py "+ argument1+" >fichierMidiComplet.py", shell=True)
fichier = open("fichierMidiComplet.py", "r")
...
mon_fichier.close()
mon_fichier = open("fichierMidiSimple.py","r")
k=-1
