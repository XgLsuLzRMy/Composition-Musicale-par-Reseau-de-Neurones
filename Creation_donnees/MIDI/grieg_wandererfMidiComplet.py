...
[midi.Track(\
  [midi.TrackNameEvent(tick=0, text='Grieg: Lyrische Stücke Op. 43 Nr. 2 - Einsamer Wanderer', data=[71, 114, 105, 101, 103, 58, 32, 76, 121, 114, 105, 115, 99, 104, 101, 32, 83, 116, 252, 99, 107, 101, 32, 79, 112, 46, 32, 52, 51, 32, 78, 114, 46, 32, 50, 32, 45, 32, 69, 105, 110, 115, 97, 109, 101, 114, 32, 87, 97, 110, 100, 101, 114, 101, 114]),
   ...
   midi.TextMetaEvent(tick=0, text='Allegretto semplice', data=[65, 108, 108, 101, 103, 114, 101, 116, 116, 111, 32, 115, 101, 109, 112, 108, 105, 99, 101]),
   midi.TextMetaEvent(tick=0, text='Erstellt: 16.5.2007\n', data=[69, 114, 115, 116, 101, 108, 108, 116, 58, 32, 49, 54, 46, 53, 46, 50, 48, 48, 55, 10]),
   midi.TextMetaEvent(tick=0, text='Update: 5.11.2012\n', data=[85, 112, 100, 97, 116, 101, 58, 32, 53, 46, 49, 49, 46, 50, 48, 49, 50, 10]),
   midi.TextMetaEvent(tick=0, text='Dauer: 1:41 Minuten\n', data=[68, 97, 117, 101, 114, 58, 32, 49, 58, 52, 49, 32, 77, 105, 110, 117, 116, 101, 110, 10]),
   ...
   midi.SetTempoEvent(tick=1200, data=[16, 204, 117]),
 ...
 midi.Track(\
  [midi.TrackNameEvent(tick=0, text='Pedale', data=[80, 101, 100, 97, 108, 101]),
   ...
   midi.EndOfTrackEvent(tick=0, data=[])]),
 midi.Track(\
  [midi.TrackNameEvent(tick=0, text='Grieg: Lyric pieces Op. 43 No. 2 - Solitary Traveller', data=[71, 114, 105, 101, 103, 58, 32, 76, 121, 114, 105, 99, 32, 112, 105, 101, 99, 101, 115, 32, 79, 112, 46, 32, 52, 51, 32, 78, 111, 46, 32, 50, 32, 45, 32, 83, 111, 108, 105, 116, 97, 114, 121, 32, 84, 114, 97, 118, 101, 108, 108, 101, 114]),
   midi.EndOfTrackEvent(tick=0, data=[])]),
 midi.Track(\
 ...
 midi.Track(\
  [midi.TrackNameEvent(tick=0, text='http://www.piano-midi.de/', data=[104, 116, 116, 112, 58, 47, 47, 119, 119, 119, 46, 112, 105, 97, 110, 111, 45, 109, 105, 100, 105, 46, 100, 101, 47]),
   midi.EndOfTrackEvent(tick=0, data=[])]),
 midi.Track(\
  [midi.TrackNameEvent(tick=0, text='Edition: 2012-11-05', data=[69, 100, 105, 116, 105, 111, 110, 58, 32, 50, 48, 49, 50, 45, 49, 49, 45, 48, 53]),
   midi.EndOfTrackEvent(tick=0, data=[])]),
 midi.Track(\
